...
class textBox {
    ...
    constructor(x, y, width, height, text, fontSize, fontName, align="center") {
        ...
        if (this.align[0] === 'top') {
            ...
            this.y += (textHeight + this.height) / 2;
        }

        if (this.align[0] == 'center') {
            log.warn('You used the word "center" for the vertical alignment. This is not a valid option. Please use "top", "middle", or "bottom" instead.');
        }
